                    ...
                    <div class="container"> 
                        <div class="row">                    
                            <div class="list-group col-md-3">
                                ...
                                <a class="list-group-item" href="{{ route('chat.show', $one->id) }}">{{ $one->name }}</a>
                                @endforeach
                            </div>
                            <div class="col-md-9">
                                <div class="card">
                                    <div class="card-header bg-primary text-white text-center font-weight-bold">{{ $user->name}}</div>
                                    <div class="card-body">
                                    @foreach ($msgs as $msg)
                                        ...
                                        <div class="border rounded col-md-6 offset-md-6 bg-primary text-white">
                                            <p class="text-right m-0 pt-2">{{ $msg->content }}</p>
